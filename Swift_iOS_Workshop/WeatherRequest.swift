...
class WeatherRequest: NSObject {
    let urlTemplate = "http://api.openweathermap.org/data/2.5/weather?lat=%d&lon=%d&lang=de&units=metric"
    ...
    func performRequest() {
        ...
        let urlStr = "http://api.openweathermap.org/data/2.5/weather?lat=\(latitude)&lon=\(longitude)&lang=de&units=metric"
